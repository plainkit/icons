...
func CassetteTape(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgCircle(html.ACx("8"), html.ACy("10"), html.AR("2"))),
		html.Child(html.SvgPath(html.AD("M8 12h8"))),
		html.Child(html.SvgCircle(html.ACx("16"), html.ACy("10"), html.AR("2"))),
		html.Child(html.SvgPath(html.AD("m6 20 .7-2.9A1.4 1.4 0 0 1 8.1 16h7.8a1.4 1.4 0 0 1 1.4 1l.7 3"))),
	}
