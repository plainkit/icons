...
func TestFileChartColumnIncreasing_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(FileChartColumnIncreasing())
	...
	// Load reference SVG
	f, err := os.Open("icons/file-chart-column-increasing.svg")
