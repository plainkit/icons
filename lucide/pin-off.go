...
func PinOff(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("M15 9.34V7a1 1 0 0 1 1-1 2 2 0 0 0 0-4H7.89")),
		html.SvgPath(html.AD("m2 2 20 20")),
		html.SvgPath(html.AD("M9 9v1.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24V16a1 1 0 0 0 1 1h11")),
	}
