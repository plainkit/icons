...
func MessageCircleQuestionMark(args ...html.SvgArg) html.Node {
	svgArgs := withLucideDefaults("lucide lucide-message-circle-question-mark", args)
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"))),
