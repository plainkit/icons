...
func CandyOff(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M10 10v7.9")),
		html.SvgPath(html.AD("M11.802 6.145a5 5 0 0 1 6.053 6.053")),
		html.SvgPath(html.AD("M14 6.1v2.243")),
		html.SvgPath(html.AD("m15.5 15.571-.964.964a5 5 0 0 1-7.071 0 5 5 0 0 1 0-7.07l.964-.965")),
