...
func TestAlignHorizontalJustifyStart_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignHorizontalJustifyStart())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-horizontal-justify-start.svg")
