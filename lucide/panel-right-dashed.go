...
func PanelRightDashed(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M15 14v1"))),
		html.Child(html.SvgPath(html.AD("M15 19v2"))),
		html.Child(html.SvgPath(html.AD("M15 3v2"))),
		html.Child(html.SvgPath(html.AD("M15 9v1"))),
	}
