...
func Link2Off(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M9 17H7A5 5 0 0 1 7 7"))),
		html.Child(html.SvgPath(html.AD("M15 7h2a5 5 0 0 1 4 8"))),
		html.Child(html.SvgLine(html.AX1("8"), html.AX2("12"), html.AY1("12"), html.AY2("12"))),
