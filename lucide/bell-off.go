...
func BellOff(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("M17 17H4a1 1 0 0 1-.74-1.673C4.59 13.956 6 12.499 6 8a6 6 0 0 1 .258-1.742")),
		html.SvgPath(html.AD("m2 2 20 20")),
		html.SvgPath(html.AD("M8.668 3.01A6 6 0 0 1 18 8c0 2.687.77 4.653 1.707 6.05")),
	}
