...
func Candy(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M10 7v10.9"))),
		html.Child(html.SvgPath(html.AD("M14 6.1V17"))),
		...
		html.Child(html.SvgPath(html.AD("M16.536 7.465a5 5 0 0 0-7.072 0l-2 2a5 5 0 0 0 0 7.07 5 5 0 0 0 7.072 0l2-2a5 5 0 0 0 0-7.07"))),
