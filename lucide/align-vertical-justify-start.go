...
func AlignVerticalJustifyStart(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgRect(html.AWidth("14"), html.AHeight("6"), html.AX("5"), html.AY("16"), html.ARx("2")),
		html.SvgRect(html.AWidth("10"), html.AHeight("6"), html.AX("7"), html.AY("6"), html.ARx("2")),
		html.SvgPath(html.AD("M2 2h20")),
	}
