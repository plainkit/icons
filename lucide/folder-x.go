...
func FolderX(args ...html.SvgArg) html.Node {
	svgArgs := withLucideDefaults("lucide lucide-folder-x", args)
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("m9.5 10.5 5 5"))),
		html.Child(html.SvgPath(html.AD("m14.5 10.5-5 5"))),
	}
