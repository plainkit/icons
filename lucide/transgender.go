...
func Transgender(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("M14 20h-4")),
		html.SvgPath(html.AD("M18 2h4v4")),
		html.SvgPath(html.AD("m2 2 7.17 7.17")),
		html.SvgPath(html.AD("M2 5.355V2h3.357")),
		html.SvgPath(html.AD("m22 2-7.17 7.17")),
		html.SvgPath(html.AD("M8 5 5 8")),
