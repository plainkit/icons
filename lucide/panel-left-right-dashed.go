...
func PanelLeftRightDashed(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M15 10V9")),
		html.SvgPath(html.AD("M15 15v-1")),
		html.SvgPath(html.AD("M15 21v-2")),
		html.SvgPath(html.AD("M15 5V3")),
		html.SvgPath(html.AD("M9 10V9")),
		html.SvgPath(html.AD("M9 15v-1")),
		html.SvgPath(html.AD("M9 21v-2")),
		html.SvgPath(html.AD("M9 5V3")),
