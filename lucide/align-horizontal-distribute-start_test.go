...
func TestAlignHorizontalDistributeStart_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignHorizontalDistributeStart())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-horizontal-distribute-start.svg")
