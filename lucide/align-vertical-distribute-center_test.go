...
func TestAlignVerticalDistributeCenter_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignVerticalDistributeCenter())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-vertical-distribute-center.svg")
