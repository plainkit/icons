...
func TestGitPullRequestCreateArrow_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(GitPullRequestCreateArrow())
	...
	// Load reference SVG
	f, err := os.Open("icons/git-pull-request-create-arrow.svg")
