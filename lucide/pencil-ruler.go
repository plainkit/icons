...
func PencilRuler(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M13 7 8.7 2.7a2.41 2.41 0 0 0-3.4 0L2.7 5.3a2.41 2.41 0 0 0 0 3.4L7 13"))),
		html.Child(html.SvgPath(html.AD("m8 6 2-2"))),
		html.Child(html.SvgPath(html.AD("m18 16 2-2"))),
		html.Child(html.SvgPath(html.AD("m17 11 4.3 4.3c.94.94.94 2.46 0 3.4l-2.6 2.6c-.94.94-2.46.94-3.4 0L11 17"))),
