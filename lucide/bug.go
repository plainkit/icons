...
func Bug(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M12 20v-9")),
		html.SvgPath(html.AD("M14 7a4 4 0 0 1 4 4v3a6 6 0 0 1-12 0v-3a4 4 0 0 1 4-4z")),
		html.SvgPath(html.AD("M14.12 3.88 16 2")),
		html.SvgPath(html.AD("M21 21a4 4 0 0 0-3.81-4")),
		html.SvgPath(html.AD("M21 5a4 4 0 0 1-3.55 3.97")),
		html.SvgPath(html.AD("M22 13h-4")),
