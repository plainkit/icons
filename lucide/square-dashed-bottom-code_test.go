...
func TestSquareDashedBottomCode_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(SquareDashedBottomCode())
	...
	// Load reference SVG
	f, err := os.Open("icons/square-dashed-bottom-code.svg")
