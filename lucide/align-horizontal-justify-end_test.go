...
func TestAlignHorizontalJustifyEnd_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignHorizontalJustifyEnd())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-horizontal-justify-end.svg")
