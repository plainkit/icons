...
func TestBetweenHorizontalStart_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(BetweenHorizontalStart())
	...
	// Load reference SVG
	f, err := os.Open("icons/between-horizontal-start.svg")
