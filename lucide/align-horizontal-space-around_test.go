...
func TestAlignHorizontalSpaceAround_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignHorizontalSpaceAround())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-horizontal-space-around.svg")
