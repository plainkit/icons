...
func TestAlignVerticalDistributeStart_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignVerticalDistributeStart())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-vertical-distribute-start.svg")
