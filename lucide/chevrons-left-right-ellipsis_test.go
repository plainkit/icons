...
func TestChevronsLeftRightEllipsis_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(ChevronsLeftRightEllipsis())
	...
	// Load reference SVG
	f, err := os.Open("icons/chevrons-left-right-ellipsis.svg")
