...
func ThermometerSnowflake(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M10.585 15H10"))),
		html.Child(html.SvgPath(html.AD("M2 12h6.5L10 9"))),
		html.Child(html.SvgPath(html.AD("M20 14.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0z"))),
		html.Child(html.SvgPath(html.AD("m4 10 1.5 2L4 14"))),
		html.Child(html.SvgPath(html.AD("m7 21 3-6-1.5-3"))),
		html.Child(html.SvgPath(html.AD("m7 3 3 6h2"))),
	}
