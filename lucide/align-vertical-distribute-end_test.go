...
func TestAlignVerticalDistributeEnd_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignVerticalDistributeEnd())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-vertical-distribute-end.svg")
