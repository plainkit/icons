...
func FileClock(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("M16 22h2a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v3")),
		html.SvgPath(html.AD("M8 14v2.2l1.6 1")),
		html.SvgCircle(html.ACx("8"), html.ACy("16"), html.AR("6")),
	}
