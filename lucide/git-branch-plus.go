...
func GitBranchPlus(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M6 3v12"))),
		html.Child(html.SvgPath(html.AD("M18 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"))),
		html.Child(html.SvgPath(html.AD("M6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"))),
		html.Child(html.SvgPath(html.AD("M15 6a9 9 0 0 0-9 9"))),
