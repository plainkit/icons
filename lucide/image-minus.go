...
func ImageMinus(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M21 9v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7"))),
		html.Child(html.SvgLine(html.AX1("16"), html.AX2("22"), html.AY1("5"), html.AY2("5"))),
