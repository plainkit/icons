...
func ClipboardPaste(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M11 14h10")),
		html.SvgPath(html.AD("M16 4h2a2 2 0 0 1 2 2v1.344")),
		html.SvgPath(html.AD("m17 18 4-4-4-4")),
		html.SvgPath(html.AD("M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 1.793-1.113")),
