...
func TestSquareArrowOutDownRight_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(SquareArrowOutDownRight())
	...
	// Load reference SVG
	f, err := os.Open("icons/square-arrow-out-down-right.svg")
