...
func TestChartNoAxesColumnDecreasing_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(ChartNoAxesColumnDecreasing())
	...
	// Load reference SVG
	f, err := os.Open("icons/chart-no-axes-column-decreasing.svg")
