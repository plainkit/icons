...
func TestCircleArrowOutDownRight_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(CircleArrowOutDownRight())
	...
	// Load reference SVG
	f, err := os.Open("icons/circle-arrow-out-down-right.svg")
