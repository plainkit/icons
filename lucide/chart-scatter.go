...
func ChartScatter(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgCircle(html.ACx("18.5"), html.ACy("5.5"), html.AR(".5"), html.AFill("currentColor")),
		html.SvgCircle(html.ACx("11.5"), html.ACy("11.5"), html.AR(".5"), html.AFill("currentColor")),
		html.SvgCircle(html.ACx("7.5"), html.ACy("16.5"), html.AR(".5"), html.AFill("currentColor")),
		html.SvgCircle(html.ACx("17.5"), html.ACy("14.5"), html.AR(".5"), html.AFill("currentColor")),
