...
func Linkedin(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z")),
		html.SvgRect(html.AWidth("4"), html.AHeight("12"), html.AX("2"), html.AY("9")),
