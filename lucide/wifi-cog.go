...
func WifiCog(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("M2 7.82a15 15 0 0 1 20 0")),
		html.SvgPath(html.AD("m20.772 16.852.924-.383")),
		html.SvgPath(html.AD("m20.772 19.148.924.383")),
		html.SvgPath(html.AD("M5 11.858a10 10 0 0 1 11.5-1.785")),
		html.SvgPath(html.AD("M8.5 15.429a5 5 0 0 1 2.413-1.31")),
