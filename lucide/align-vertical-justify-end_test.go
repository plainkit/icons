...
func TestAlignVerticalJustifyEnd_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignVerticalJustifyEnd())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-vertical-justify-end.svg")
