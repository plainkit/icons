...
func TestSquareArrowOutUpRight_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(SquareArrowOutUpRight())
	...
	// Load reference SVG
	f, err := os.Open("icons/square-arrow-out-up-right.svg")
