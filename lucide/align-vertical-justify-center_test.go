...
func TestAlignVerticalJustifyCenter_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignVerticalJustifyCenter())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-vertical-justify-center.svg")
