...
func CalendarCog(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("m15.228 19.148-.923.383")),
		html.SvgPath(html.AD("M16 2v4")),
		html.SvgPath(html.AD("m16.47 14.305.382.923")),
		...
		html.SvgPath(html.AD("M21 10.592V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6")),
