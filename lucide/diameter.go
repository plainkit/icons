...
func Diameter(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("M6.48 3.66a10 10 0 0 1 13.86 13.86")),
		html.SvgPath(html.AD("m6.41 6.41 11.18 11.18")),
		html.SvgPath(html.AD("M3.66 6.48a10 10 0 0 0 13.86 13.86")),
	}
