...
func CloudHail(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("M16 14v2")),
		html.SvgPath(html.AD("M8 14v2")),
		html.SvgPath(html.AD("M16 20h.01")),
		html.SvgPath(html.AD("M8 20h.01")),
		html.SvgPath(html.AD("M12 16v2")),
		html.SvgPath(html.AD("M12 22h.01")),
	}
