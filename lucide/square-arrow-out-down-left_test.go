...
func TestSquareArrowOutDownLeft_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(SquareArrowOutDownLeft())
	...
	// Load reference SVG
	f, err := os.Open("icons/square-arrow-out-down-left.svg")
