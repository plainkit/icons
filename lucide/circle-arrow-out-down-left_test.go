...
func TestCircleArrowOutDownLeft_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(CircleArrowOutDownLeft())
	...
	// Load reference SVG
	f, err := os.Open("icons/circle-arrow-out-down-left.svg")
