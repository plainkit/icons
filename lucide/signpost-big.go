...
func SignpostBig(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M10 9H4L2 7l2-2h6"))),
		html.Child(html.SvgPath(html.AD("M14 5h6l2 2-2 2h-6"))),
		html.Child(html.SvgPath(html.AD("M10 22V4a2 2 0 1 1 4 0v18"))),
