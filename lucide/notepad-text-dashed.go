...
func NotepadTextDashed(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M16 4h2a2 2 0 0 1 2 2v2"))),
		html.Child(html.SvgPath(html.AD("M20 12v2"))),
		html.Child(html.SvgPath(html.AD("M20 18v2a2 2 0 0 1-2 2h-1"))),
		html.Child(html.SvgPath(html.AD("M13 22h-2"))),
		html.Child(html.SvgPath(html.AD("M7 22H6a2 2 0 0 1-2-2v-2"))),
		html.Child(html.SvgPath(html.AD("M4 14v-2"))),
		html.Child(html.SvgPath(html.AD("M4 8V6a2 2 0 0 1 2-2h2"))),
