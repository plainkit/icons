...
func FlashlightOff(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M16 16v4a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2V10c0-2-2-2-2-4")),
		html.SvgPath(html.AD("M7 2h11v4c0 2-2 2-2 4v1")),
		html.SvgLine(html.AX1("11"), html.AX2("18"), html.AY1("6"), html.AY2("6")),
