...
func MessageSquareX(args ...html.SvgArg) html.Node {
	svgArgs := withLucideDefaults("lucide lucide-message-square-x", args)
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("m14.5 8.5-5 5"))),
		html.Child(html.SvgPath(html.AD("m9.5 8.5 5 5"))),
	}
