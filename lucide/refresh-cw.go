...
func RefreshCw(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"))),
		html.Child(html.SvgPath(html.AD("M21 3v5h-5"))),
		html.Child(html.SvgPath(html.AD("M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"))),
