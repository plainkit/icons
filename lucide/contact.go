...
func Contact(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M16 2v2")),
		html.SvgPath(html.AD("M7 22v-2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2")),
		html.SvgPath(html.AD("M8 2v2")),
		html.SvgCircle(html.ACx("12"), html.ACy("11"), html.AR("3")),
