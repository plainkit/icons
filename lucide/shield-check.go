...
// ShieldCheck creates a Shield Check Lucide icon.
func ShieldCheck(args ...html.SvgArg) html.Node {
	svgArgs := withLucideDefaults("lucide lucide-shield-check", args)
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("m9 12 2 2 4-4")),
	}
