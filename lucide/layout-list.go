...
func LayoutList(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M14 4h7"))),
		html.Child(html.SvgPath(html.AD("M14 9h7"))),
		html.Child(html.SvgPath(html.AD("M14 15h7"))),
		html.Child(html.SvgPath(html.AD("M14 20h7"))),
	}
