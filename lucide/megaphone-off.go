...
func MegaphoneOff(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M11.636 6A13 13 0 0 0 19.4 3.2 1 1 0 0 1 21 4v11.344"))),
		html.Child(html.SvgPath(html.AD("M14.378 14.357A13 13 0 0 0 11 14H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h1"))),
		...
		html.Child(html.SvgPath(html.AD("M8 8v6"))),
	}
