...
func BookOpenText(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M16 12h2"))),
		html.Child(html.SvgPath(html.AD("M16 8h2"))),
		...
		html.Child(html.SvgPath(html.AD("M6 12h2"))),
		html.Child(html.SvgPath(html.AD("M6 8h2"))),
	}
