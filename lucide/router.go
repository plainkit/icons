...
func Router(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("M6.01 18H6")),
		html.SvgPath(html.AD("M10.01 18H10")),
		html.SvgPath(html.AD("M15 10v4")),
		html.SvgPath(html.AD("M17.84 7.17a4 4 0 0 0-5.66 0")),
		html.SvgPath(html.AD("M20.66 4.34a8 8 0 0 0-11.31 0")),
	}
