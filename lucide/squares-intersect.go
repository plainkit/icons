...
func SquaresIntersect(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M14 2a2 2 0 0 1 2 2"))),
		html.Child(html.SvgPath(html.AD("M16 22h-2"))),
		html.Child(html.SvgPath(html.AD("M2 10V8"))),
		html.Child(html.SvgPath(html.AD("M2 4a2 2 0 0 1 2-2"))),
		...
		html.Child(html.SvgPath(html.AD("M4 16a2 2 0 0 1-2-2"))),
		html.Child(html.SvgPath(html.AD("M8 10a2 2 0 0 1 2-2h5a1 1 0 0 1 1 1v5a2 2 0 0 1-2 2H9a1 1 0 0 1-1-1z"))),
		html.Child(html.SvgPath(html.AD("M8 2h2"))),
	}
