...
func TestSquareBottomDashedScissors_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(SquareBottomDashedScissors())
	...
	// Load reference SVG
	f, err := os.Open("icons/square-bottom-dashed-scissors.svg")
