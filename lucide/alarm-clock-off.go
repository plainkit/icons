...
func AlarmClockOff(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M6.87 6.87a8 8 0 1 0 11.26 11.26")),
		html.SvgPath(html.AD("M19.9 14.25a8 8 0 0 0-9.15-9.15")),
		html.SvgPath(html.AD("m22 6-3-3")),
		html.SvgPath(html.AD("M6.26 18.67 4 21")),
		html.SvgPath(html.AD("m2 2 20 20")),
		html.SvgPath(html.AD("M4 4 2 6")),
	}
