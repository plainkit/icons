...
func PictureInPicture2(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M21 9V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h4")),
		html.SvgRect(html.AWidth("10"), html.AHeight("7"), html.AX("12"), html.AY("13"), html.ARx("2")),
	}
