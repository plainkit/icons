...
func Ambulance(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M10 10H6")),
		html.SvgPath(html.AD("M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2")),
		html.SvgPath(html.AD("M19 18h2a1 1 0 0 0 1-1v-3.28a1 1 0 0 0-.684-.948l-1.923-.641a1 1 0 0 1-.578-.502l-1.539-3.076A1 1 0 0 0 16.382 8H14")),
		html.SvgPath(html.AD("M8 8v4")),
		html.SvgPath(html.AD("M9 18h6")),
