...
func Footprints(args ...x.SvgArg) x.Node {
	...
	svgArgs = append(svgArgs,
		...
		x.Child(x.Path(x.D("M20 20v-2.38c0-2.12 1.03-3.12 1-5.62-.03-2.72-1.49-6-4.5-6C14.63 6 14 7.8 14 9.5c0 3.11 2 5.66 2 8.68V20a2 2 0 1 0 4 0Z"))),
		x.Child(x.Path(x.D("M16 17h4"))),
		x.Child(x.Path(x.D("M4 13h4"))),
	)
