...
func Logs(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M3 5h1"))),
		html.Child(html.SvgPath(html.AD("M3 12h1"))),
		html.Child(html.SvgPath(html.AD("M3 19h1"))),
		html.Child(html.SvgPath(html.AD("M8 5h1"))),
		html.Child(html.SvgPath(html.AD("M8 12h1"))),
		html.Child(html.SvgPath(html.AD("M8 19h1"))),
