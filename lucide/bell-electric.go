...
func BellElectric(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M18.518 17.347A7 7 0 0 1 14 19")),
		html.SvgPath(html.AD("M18.8 4A11 11 0 0 1 20 9")),
		...
		html.SvgRect(html.AWidth("10"), html.AHeight("6"), html.AX("4"), html.AY("16"), html.ARx("2")),
	}
