...
func BanknoteX(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M13 18H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5"))),
		html.Child(html.SvgPath(html.AD("m17 17 5 5"))),
		html.Child(html.SvgPath(html.AD("M18 12h.01"))),
		html.Child(html.SvgPath(html.AD("m22 17-5 5"))),
