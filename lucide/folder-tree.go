...
func FolderTree(args ...x.SvgArg) x.Node {
	...
	svgArgs = append(svgArgs,
		...
		x.Child(x.Path(x.D("M20 21a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-2.9a1 1 0 0 1-.88-.55l-.42-.85a1 1 0 0 0-.92-.6H13a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1Z"))),
		x.Child(x.Path(x.D("M3 5a2 2 0 0 0 2 2h3"))),
		x.Child(x.Path(x.D("M3 3v13a2 2 0 0 0 2 2h3"))),
	)
