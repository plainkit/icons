...
func LifeBuoy(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("m4.93 4.93 4.24 4.24")),
		html.SvgPath(html.AD("m14.83 9.17 4.24-4.24")),
		html.SvgPath(html.AD("m14.83 14.83 4.24 4.24")),
		html.SvgPath(html.AD("m9.17 14.83-4.24 4.24")),
