...
func Sparkles(args ...x.SvgArg) x.Component {
	svgArgs := buildLucideArgs("lucide lucide-sparkles", args)
	svgArgs = append(svgArgs,
		...
		x.Child(x.Path(x.D("M20 2v4"))),
		x.Child(x.Path(x.D("M22 4h-4"))),
		x.Child(x.Circle(x.Cx("4"), x.Cy("20"), x.R("2"))),
	)
