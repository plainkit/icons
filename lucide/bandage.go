...
func Bandage(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgPath(html.AD("M10 10.01h.01")),
		html.SvgPath(html.AD("M10 14.01h.01")),
		html.SvgPath(html.AD("M14 10.01h.01")),
		html.SvgPath(html.AD("M14 14.01h.01")),
		html.SvgPath(html.AD("M18 6v11.5")),
		html.SvgPath(html.AD("M6 6v12")),
