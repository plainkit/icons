...
func GalleryThumbnails(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgRect(html.AWidth("18"), html.AHeight("14"), html.AX("3"), html.AY("3"), html.ARx("2"))),
		html.Child(html.SvgPath(html.AD("M4 21h1"))),
		html.Child(html.SvgPath(html.AD("M9 21h1"))),
		html.Child(html.SvgPath(html.AD("M14 21h1"))),
		html.Child(html.SvgPath(html.AD("M19 21h1"))),
	}
