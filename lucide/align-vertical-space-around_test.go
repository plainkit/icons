...
func TestAlignVerticalSpaceAround_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignVerticalSpaceAround())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-vertical-space-around.svg")
