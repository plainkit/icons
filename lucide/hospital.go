...
func Hospital(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M14 9h-4"))),
		html.Child(html.SvgPath(html.AD("M18 11h2a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-9a2 2 0 0 1 2-2h2"))),
		html.Child(html.SvgPath(html.AD("M18 21V5a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16"))),
	}
