...
func MessageCircleCode(args ...html.SvgArg) html.Node {
	svgArgs := withLucideDefaults("lucide lucide-message-circle-code", args)
	children := []html.SvgArg{
		html.SvgPath(html.AD("m10 9-3 3 3 3")),
		html.SvgPath(html.AD("m14 15 3-3-3-3")),
