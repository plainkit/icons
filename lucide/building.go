...
func Building(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M16 6h.01"))),
		html.Child(html.SvgPath(html.AD("M8 10h.01"))),
		html.Child(html.SvgPath(html.AD("M8 14h.01"))),
		html.Child(html.SvgPath(html.AD("M8 6h.01"))),
		html.Child(html.SvgPath(html.AD("M9 22v-3a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3"))),
