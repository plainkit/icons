...
func BatteryWarning(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M10 17h.01"))),
		html.Child(html.SvgPath(html.AD("M10 7v6"))),
		html.Child(html.SvgPath(html.AD("M14 6h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2"))),
		html.Child(html.SvgPath(html.AD("M22 14v-4"))),
		html.Child(html.SvgPath(html.AD("M6 18H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h2"))),
	}
