...
func TestSquareDashedMousePointer_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(SquareDashedMousePointer())
	...
	// Load reference SVG
	f, err := os.Open("icons/square-dashed-mouse-pointer.svg")
