...
func UtilityPole(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M3 3v2"))),
		html.Child(html.SvgPath(html.AD("M7 3v2"))),
		html.Child(html.SvgPath(html.AD("M17 3v2"))),
		html.Child(html.SvgPath(html.AD("M21 3v2"))),
		html.Child(html.SvgPath(html.AD("m19 5-7 7-7-7"))),
	}
