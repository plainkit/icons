...
func TestAlignHorizontalDistributeEnd_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignHorizontalDistributeEnd())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-horizontal-distribute-end.svg")
