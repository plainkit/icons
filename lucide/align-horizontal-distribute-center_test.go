...
func TestAlignHorizontalDistributeCenter_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignHorizontalDistributeCenter())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-horizontal-distribute-center.svg")
