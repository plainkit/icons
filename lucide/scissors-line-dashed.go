...
func ScissorsLineDashed(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("M5.42 9.42 8 12"))),
		html.Child(html.SvgCircle(html.ACx("4"), html.ACy("8"), html.AR("2"))),
		html.Child(html.SvgPath(html.AD("m14 6-8.58 8.58"))),
		html.Child(html.SvgCircle(html.ACx("4"), html.ACy("16"), html.AR("2"))),
		html.Child(html.SvgPath(html.AD("M10.8 14.8 14 18"))),
