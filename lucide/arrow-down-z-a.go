...
func ArrowDownZA(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M15 4h5l-5 6h5"))),
		html.Child(html.SvgPath(html.AD("M15 20v-3.5a2.5 2.5 0 0 1 5 0V20"))),
		html.Child(html.SvgPath(html.AD("M20 18h-5"))),
	}
