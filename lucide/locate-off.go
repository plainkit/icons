...
func LocateOff(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPath(html.AD("M18.89 13.24a7 7 0 0 0-8.13-8.13")),
		html.SvgPath(html.AD("M19 12h3")),
		html.SvgPath(html.AD("M2 12h3")),
		html.SvgPath(html.AD("m2 2 20 20")),
		html.SvgPath(html.AD("M7.05 7.05a7 7 0 0 0 9.9 9.9")),
	}
