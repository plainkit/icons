...
func FerrisWheel(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("m6.8 15-3.5 2"))),
		html.Child(html.SvgPath(html.AD("m20.7 7-3.5 2"))),
		html.Child(html.SvgPath(html.AD("M6.8 9 3.3 7"))),
		html.Child(html.SvgPath(html.AD("m20.7 17-3.5-2"))),
		html.Child(html.SvgPath(html.AD("m9 22 3-8 3 8"))),
		html.Child(html.SvgPath(html.AD("M8 22h8"))),
		html.Child(html.SvgPath(html.AD("M18 18.7a9 9 0 1 0-12 0"))),
	}
