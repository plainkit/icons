...
func TestCircleArrowOutUpRight_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(CircleArrowOutUpRight())
	...
	// Load reference SVG
	f, err := os.Open("icons/circle-arrow-out-up-right.svg")
