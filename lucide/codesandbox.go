...
func Codesandbox(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPolyline(html.APoints("7.5 4.21 12 6.81 16.5 4.21")),
		html.SvgPolyline(html.APoints("7.5 19.79 7.5 14.6 3 12")),
		html.SvgPolyline(html.APoints("21 12 16.5 14.6 16.5 19.79")),
		html.SvgPolyline(html.APoints("3.27 6.96 12 12.01 20.73 6.96")),
		html.SvgLine(html.AX1("12"), html.AX2("12"), html.AY1("22.08"), html.AY2("12")),
	}
