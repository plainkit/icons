...
func TestAlignHorizontalSpaceBetween_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignHorizontalSpaceBetween())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-horizontal-space-between.svg")
