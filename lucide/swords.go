...
func Swords(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgPolyline(html.APoints("14.5 6.5 18 3 21 3 21 6 17.5 9.5")),
		html.SvgLine(html.AX1("5"), html.AX2("9"), html.AY1("14"), html.AY2("18")),
		html.SvgLine(html.AX1("7"), html.AX2("4"), html.AY1("17"), html.AY2("20")),
		html.SvgLine(html.AX1("3"), html.AX2("5"), html.AY1("19"), html.AY2("21")),
	}
