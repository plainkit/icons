...
func Expand(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.Child(html.SvgPath(html.AD("m15 15 6 6"))),
		...
		html.Child(html.SvgPath(html.AD("M3 16v5h5"))),
		html.Child(html.SvgPath(html.AD("m3 21 6-6"))),
		html.Child(html.SvgPath(html.AD("M3 8V3h5"))),
		html.Child(html.SvgPath(html.AD("M9 9 3 3"))),
	}
