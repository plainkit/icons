...
func CircuitBoard(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.Child(html.SvgPath(html.AD("M11 9h4a2 2 0 0 0 2-2V3"))),
		html.Child(html.SvgCircle(html.ACx("9"), html.ACy("9"), html.AR("2"))),
		html.Child(html.SvgPath(html.AD("M7 21v-4a2 2 0 0 1 2-2h4"))),
		html.Child(html.SvgCircle(html.ACx("15"), html.ACy("15"), html.AR("2"))),
	}
