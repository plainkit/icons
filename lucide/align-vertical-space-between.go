...
func AlignVerticalSpaceBetween(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgRect(html.AWidth("14"), html.AHeight("6"), html.AX("5"), html.AY("15"), html.ARx("2")),
		html.SvgRect(html.AWidth("10"), html.AHeight("6"), html.AX("7"), html.AY("3"), html.ARx("2")),
		html.SvgPath(html.AD("M2 21h20")),
		html.SvgPath(html.AD("M2 3h20")),
	}
