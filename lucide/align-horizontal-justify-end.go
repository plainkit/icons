...
func AlignHorizontalJustifyEnd(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		html.SvgRect(html.AWidth("6"), html.AHeight("14"), html.AX("2"), html.AY("5"), html.ARx("2")),
		html.SvgRect(html.AWidth("6"), html.AHeight("10"), html.AX("12"), html.AY("7"), html.ARx("2")),
		html.SvgPath(html.AD("M22 2v20")),
	}
