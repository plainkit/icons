...
func FileVideoCamera(args ...html.SvgArg) html.Node {
	...
	children := []html.SvgArg{
		...
		html.SvgRect(html.AWidth("8"), html.AHeight("6"), html.AX("2"), html.AY("12"), html.ARx("1")),
		html.SvgPath(html.AD("m10 13.843 3.033-1.755a.645.645 0 0 1 .967.56v4.704a.645.645 0 0 1-.967.56L10 16.157")),
	}
