...
func TestMessageCircleQuestionMark_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(MessageCircleQuestionMark())
	...
	// Load reference SVG
	f, err := os.Open("icons/message-circle-question-mark.svg")
