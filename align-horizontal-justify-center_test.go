...
func TestAlignHorizontalJustifyCenter_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignHorizontalJustifyCenter())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-horizontal-justify-center.svg")
