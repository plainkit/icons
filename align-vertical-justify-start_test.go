...
func TestAlignVerticalJustifyStart_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignVerticalJustifyStart())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-vertical-justify-start.svg")
