...
func TestAlignVerticalSpaceBetween_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(AlignVerticalSpaceBetween())
	...
	// Load reference SVG
	f, err := os.Open("icons/align-vertical-space-between.svg")
