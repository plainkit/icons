...
func TestChartNoAxesColumnIncreasing_SVGMatchesReference(t *testing.T) {
	// Render the component
	rendered := x.Render(ChartNoAxesColumnIncreasing())
	...
	// Load reference SVG
	f, err := os.Open("icons/chart-no-axes-column-increasing.svg")
